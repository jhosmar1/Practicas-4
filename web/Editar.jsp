    ...
    <body>
       ...
       while(rs.next()){
        ...
        <div class="container">
            ...
            <hr>
            <form action="" method="post" class="form-control" style="width: 600px; height: 450px">
                <!-- ID:
                <input type="text" readonly="" class="form-control" value="<%= rs.getInt("Id_Usuario")%>"/> -->
                Fecha:
                <input type="text" name="txtFecha" class="form-control" value="<%= rs.getString("Fecha")%>"/><br>
               ...
               <!--<input type="text" name="txtDNI" class="form-control" value="<%= rs.getString("DNI")%>"/> -->
                <textarea type="text" name="txtDNI" class="form-control" rows="7"/><%= rs.getString("DNI")%></textarea>
                
                 <br>
                <center><input type="submit" value="Guardar" class="btn btn-primary btn-lg"/>
                
                    <a href="principal.jsp" >Regresar</a> </center>
            </form>
            <%}%>
        </div>
    </body>
